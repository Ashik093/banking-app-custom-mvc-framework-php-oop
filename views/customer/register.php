<?php
  ...
  require_once __DIR__.'/layout/auth/header.php'; 
?>
        ...
        <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
          <form
            ...
            <div>
              ...
              <?php 
                if(isset($_GET['errors']['firstName'])){
                  echo '<p class="text-red-500 text-xs italic mt-1">'.$_GET['errors']['firstName'].'</p>';
                }
              ?>
            ...
            <div>
              ...
              <?php 
                if(isset($_GET['errors']['lastName'])){
                  echo '<p class="text-red-500 text-xs italic mt-1">'.$_GET['errors']['lastName'].'</p>';
                }
              ?>
            </div>
            <div>
              ...
              <?php 
                if(isset($_GET['errors']['email'])){
                  echo '<p class="text-red-500 text-xs italic mt-1">'.$_GET['errors']['email'].'</p>';
                }
              ?>
            </div>
            ...
            <div>
              ...
              <?php 
                if(isset($_GET['errors']['password'])){
                  echo '<p class="text-red-500 text-xs italic mt-1">'.$_GET['errors']['password'].'</p>';
                }
              ?>
            </div>
